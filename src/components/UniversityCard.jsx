      ...
      <div className="p-6 flex flex-col grow bg-white">
        ...
        <ul className="space-y-3 mb-6 grow">
          ...
          <li className="flex items-center gap-3">
            ...
            <span className="text-sm text-gray-600 font-medium">{university.nivel || 'Pregrado'}</span>
          </li>

          <li className="flex items-center gap-3">
            <Landmark className="w-5 h-5 text-blue-500 shrink-0" />
            <span className="text-sm text-gray-600 font-medium">{university.tipo || 'Pública'}</span>
          </li>
        </ul>
        ...
        <div className="mt-auto flex flex-col gap-2">
          ...
          <a
            ...
            className="flex items-center justify-center w-full py-2.5 bg-purple-50 text-purple-700 hover:bg-purple-600 hover:text-white font-bold rounded-xl transition-all duration-300 shadow-sm border border-purple-100"
          >
