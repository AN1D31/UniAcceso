...
export default function EarlyAccess() {
  ...
  return (
    <div className="min-h-screen bg-[#0b0b0f] flex flex-col justify-between relative px-6 py-8 overflow-hidden text-gray-100 font-sans">
      <div className="absolute w-100 h-100 bg-purple-600 rounded-full blur-[120px] opacity-20 -top-20 -left-20 pointer-events-none"></div>
      <div className="absolute w-100 h-100 bg-emerald-500 rounded-full blur-[120px] opacity-15 -bottom-20 -right-20 pointer-events-none"></div>

      <header className="flex justify-between items-center z-10 max-w-6xl mx-auto w-full">
        <div className="text-2xl font-extrabold tracking-tight">
          Uni<span className="text-purple-500">Acceso</span>
        </div>
        <span className="bg-purple-500/10 border border-purple-500/30 text-purple-400 px-4 py-1.5 rounded-full text-sm font-semibold">
          Próximamente App Móvil
        </span>
      </header>

      <main className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center z-10 max-w-6xl mx-auto w-full my-12">
        ...
        <div className="flex justify-center items-center">
          <img
            ...
            className="w-full max-w-sm drop-shadow-[0_25px_50px_rgba(0,0,0,0.6)] hover:-translate-y-3 transition-transform duration-700 ease-in-out"
          />
        </div>
      </main>

      {/* Footer */}
      <footer className="text-center text-gray-500 text-sm z-10 max-w-6xl mx-auto w-full">
